...
#Importiamo la funzione variabili del file views.py
...
urlpatterns = [
    ...
    path('index', index, name='index'), #http://localhost:8000/
    path('homepage', homepage, name='homepage'), #http://localhost:8000/homepage
    ...
    path('variabili', variabili, name='variabili'), #localhost:8000/variabili
]