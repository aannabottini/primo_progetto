...
def index_condizioni(request):
      return render(request, "index_condizioni.html")

#funzione che verrà associata alla pagina es_if.html
def es_if(request):
  context = {
    'var1' : 200,
    'var2' : 200,
...
#funzione che verrà associata alla pagina if_else_elif.html
